		...
		<main className="container additional-padding">
			<section className="portfolio">
				...
				<section className="projects">
					...
					<Card title="Project 4" github="#" deployed="#" image="https://via.placeholder.com/300" desc="lorem ipsum" />
					<Card title="Project 5" github="#" deployed="#" image="https://via.placeholder.com/300" desc="lorem ipsum" />
					<Card title="Project 6" github="#" deployed="#" image="https://via.placeholder.com/300" desc="lorem ipsum" />
				</section>
			</section>
